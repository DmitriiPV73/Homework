...
# def numbers (a,b):
#     """
#     Функция, которая выводит все четные числа в диапазоне двух
#     чисел.
#     """
#
#     if a<b:
...
#     """
#     Функция, которая выводит заполненный или пустой квадрат
...
#     """функция возвращает минимальное значение из 5 чисел"""
#     list=[a,b, c, d, e]
#     return min(list)
#
...
# def composition(x,y):
#     """Фукция возвращает произведение чисел в диапазоне"""
#     if x<y:
#         min_val=x
#         max_val=y
#     elif y<x:
...
def composition(x):
    ...
    Если палиндром - возвращает True
    Если не палиндром - возвращает False
    """
    line_x=str(x)
    list_x=list(line_x)
    count_x=len(list_x)
